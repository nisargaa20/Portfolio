            ...
            <div className=" w-[85%] h-[auto] rounded-2xl  md:w-[80%] lg:w-[80%] -z-0 backdrop-blur-sm bg-black/1 flex flex-col gap-6 lg:gap-10">
                ...
                <div className=' ml-[10%] sm:ml-[15%]'>
                    <p className='text-justify md:text-lg text-[#d5d3d3] '>
                        Hey there!<br /> <br /> I'm <span className='text-[#ffef88] font-semibold'>Nisarga G R</span>, a Software Developer with hands-on experience in both front-end and back-end technologies. My commitment to continuous learning, excellent communication, and teamwork skills equip me to contribute effectively to dynamic projects and deliver innovative solutions.

                        My keen interest in artificial intelligence expands my capabilities to contribute meaningfully to cutting-edge projects. I am eager to make a meaningful impact and actively seek opportunities to collaborate with like-minded professionals in the software development domain.
                    </p>
                </div>
                <div className=' ml-[10%] sm:ml-[15%]'>
                    ...
                    <div className=''>
                    <a href="https://drive.google.com/file/d/1GaqVY4sMiwp7nZoNFBvg0KGJi9XXBKqs/view?usp=drivesdk">
