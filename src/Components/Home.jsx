...
//                     <div className="flex flex-col justify-start items-start gap-6 sm:gap-8 md:gap-10 lg:max-w-md xl:max-w-2xl xl:p-5">
//                         <div>
...
//     <span ref={typingRef} style={{ marginBottom: '1rem' }} className="typing-text text-lg md:text-xl lg:text-2xl xl:text-3xl text-[#c59b5c]"></span>
// </h2>

//                         </div>
//                         <div className='w-full flex flex-col sm:flex-row items-center justify-center sm:justify-start gap-4'>
//                             <a href="https://drive.google.com/file/d/1DT58guVB8ZNhLOgKBCLdEtqQgbga-UxI/view?usp=drivesdk" target="_blank" rel="noopener noreferrer">
...
//                  <div className="profile-image-container max-w-xs sm:max-w-sm md:max-w-md lg:max-w-lg rounded-full overflow-hidden mt-6 md:mt-0 image-container-wrapper">
//     <img src={profile} alt='Nisarga' className="w-full h-auto" />
// </div>
